  ...
  return (
    <View style={styles.sectionStack}>
      <Panel title="Telegram">
        ...
        <PrimaryButton label={t.openWeb} onPress={() => Linking.openURL(`${API_BASE_URL}/pro/settings?section=telegram`)} />
      </Panel>
    </View>
  );
}
  ...
  return (
    <View style={styles.sectionStack}>
      <Panel title={t.settings}>
        ...
        {workspace?.business.publicBookingUrl ? (
          <SecondaryButton label={t.publicPage} onPress={() => Linking.openURL(workspace.business.publicBookingUrl || API_BASE_URL)} />
        ) : null}
