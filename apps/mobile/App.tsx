...
const CALENDAR_TIME_AXIS_WIDTH = 32;
...
const styles = StyleSheet.create({
  ...
  teamPickerRail: {
    ...
    borderRightWidth: 1,
    borderBottomWidth: 1,
    borderRightColor: "rgba(226, 232, 240, 0.46)",
    borderBottomColor: "rgba(226, 232, 240, 0.50)",
    backgroundColor: "rgba(255,255,255,0.88)",
  },
  teamPickerRailBody: {
  ...
  teamDayColumn: {
    overflow: "hidden",
    borderRightWidth: 1,
    borderRightColor: "rgba(226, 232, 240, 0.48)",
    backgroundColor: "#FFFFFF",
  },
  teamDayHeader: {
    alignItems: "center",
  ...
  hourGrid: {
    ...
    position: "relative",
    borderLeftWidth: 1,
    borderLeftColor: "rgba(226, 232, 240, 0.34)",
  },
  majorLine: {
    position: "absolute",
    left: 0,
  ...
  fabButton: {
    ...
    backgroundColor: "rgba(109, 74, 255, 0.86)",
    shadowColor: DESIGN.colors.primary,
    shadowOpacity: 0.20,
    shadowRadius: 28,
