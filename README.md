...
MONOBANK_CURRENCY_CODE=840
MONOBANK_PRICE_MONTHLY_USD=3
MONOBANK_PRICE_YEARLY_USD=29
```

`MONOBANK_CURRENCY_CODE=840` означает USD. Сумма в API передаётся в минимальных единицах валюты, поэтому `$3` уходит как `300`, а `$29` как `2900`.
