...
Object.assign(catalogCopy, {
  fr: {
    ...
    heroText:
      "Certains professionnels rendent leur profil Timviz visible dans la recherche pour aider les clients à trouver une page de réservation.",
    ...
    onlineBookingDisabled: "Réservation en ligne désactivée",
    ...
    availableAt: (time: string) => `Disponible à ${time}`,
    ...
    mapHint: "Points des entreprises sur la carte",
    ...
    onlineBookingShort: "Réservation en ligne",
  ...
  pl: {
    ...
    heroText:
      "Niektórzy specjaliści udostępniają swój profil Timviz w wyszukiwarce, aby klientom łatwiej było znaleźć stronę rezerwacji.",
    ...
    onlineBookingDisabled: "Rezerwacja online jest wyłączona",
    ...
    onlineBookingShort: "Rezerwacja online",
  ...
  cs: {
    ...
    heroText:
      "Někteří profesionálové zviditelňují svůj profil Timviz ve vyhledávání, aby klienti snáze našli rezervační stránku.",
    anyTime: "Kdykoliv",
    ...
    onlineBookingDisabled: "Online rezervace je vypnutá",
    ...
    onlineBookingShort: "Online rezervace",
  ...
  es: {
    ...
    heroText:
      "Algunos profesionales hacen visible su perfil de Timviz en la búsqueda para que los clientes encuentren más fácil la página de reserva.",
    ...
    onlineBookingDisabled: "La reserva online está desactivada",
    ...
    onlineBookingShort: "Reserva online",
  ...
  de: {
    ...
    heroText:
      "Einige Profis machen ihr Timviz Profil in der Suche sichtbar, damit Kunden die Buchungsseite leichter finden.",
    ...
    onlineBookingDisabled: "Online-Buchung ist aus",
    ...
    onlineBookingShort: "Online-Buchung",
