...
const copy = withEnglishFallback<Record<string, string | string[][]>>({
  ru: {
    ...
    appText: "Ведите записи, услуги, клиентов и график с телефона. Timviz Master уже доступен в App Store для iPhone.",
    appButton: "Скачать Timviz Master",
    appSoon: "Timviz Master уже доступен в App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    comingSoon: "Скоро",
    mobileAppsFooter: "Timviz Master в App Store",
  ...
  uk: {
    ...
    appText: "Керуйте записами, послугами, клієнтами й графіком з телефона. Timviz Master уже доступний в App Store для iPhone.",
    appButton: "Завантажити Timviz Master",
    appSoon: "Timviz Master уже доступний в App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    comingSoon: "Скоро",
    mobileAppsFooter: "Timviz Master в App Store",
  ...
  en: {
    ...
    appText: "Manage bookings, services, clients and your schedule from your phone. Timviz Master is now available on the App Store for iPhone.",
    appButton: "Download Timviz Master",
    appSoon: "Timviz Master is available on the App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    comingSoon: "Coming soon",
    mobileAppsFooter: "Timviz Master on the App Store",
    appCardTitle: "Trendy Studio",
...
Object.assign(copy, {
  fr: {
    ...
    appText: "Gérez vos rendez-vous, services, clients et planning depuis votre téléphone. Timviz Master est disponible sur l’App Store pour iPhone.",
    appButton: "Télécharger Timviz Master",
    appSoon: "Timviz Master est disponible sur l’App Store",
    comingSoon: "Bientôt disponible",
    mobileAppsFooter: "Timviz Master sur l’App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
  ...
  pl: {
    ...
    appText: "Zarządzaj wizytami, usługami, klientami i grafikiem z telefonu. Timviz Master jest dostępny w App Store na iPhone’a.",
    appButton: "Pobierz Timviz Master",
    appSoon: "Timviz Master jest dostępny w App Store",
    comingSoon: "Wkrótce",
    mobileAppsFooter: "Timviz Master w App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
  ...
  cs: {
    ...
    appText: "Spravujte objednávky, služby, klienty a rozvrh z telefonu. Timviz Master je dostupný v App Storu pro iPhone.",
    appButton: "Stáhnout Timviz Master",
    appSoon: "Timviz Master je dostupný v App Storu",
    comingSoon: "Již brzy",
    mobileAppsFooter: "Timviz Master v App Storu",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
  ...
  es: {
    ...
    appText: "Gestiona citas, servicios, clientes y horarios desde el teléfono. Timviz Master ya está disponible en App Store para iPhone.",
    appButton: "Descargar Timviz Master",
    appSoon: "Timviz Master está disponible en App Store",
    comingSoon: "Próximamente",
    mobileAppsFooter: "Timviz Master en App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Londres",
  ...
  de: {
    ...
    appText: "Verwalten Sie Termine, Leistungen, Kunden und Ihren Zeitplan direkt vom Telefon. Timviz Master ist im App Store für iPhone verfügbar.",
    appButton: "Timviz Master laden",
    appSoon: "Timviz Master ist im App Store verfügbar",
    comingSoon: "Demnächst",
    mobileAppsFooter: "Timviz Master im App Store",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · London",
