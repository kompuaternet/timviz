...
const copy = withEnglishFallback<Record<string, string | string[][]>>({
  ru: {
    ...
    heroTitle: "Записывайтесь на услуги рядом",
    heroText: "Все услуги, которые нужны каждый день, теперь в одном месте.",
    bookedToday: "записей создано сегодня",
    recommended: "Рекомендуемые",
    seeAll: "Смотреть все →",
    appKicker: "Доступно для мастеров",
    appTitle: "Скачайте Timviz Master",
    appText: "Ведите записи, услуги, клиентов и график с телефона. Timviz Master доступен как мобильное приложение.",
    appButton: "Скачать Timviz Master",
    appSoon: "Timviz Master доступен как мобильное приложение",
    appStore: "App Store",
    googlePlay: "Google Play",
    comingSoon: "Скоро",
    mobileAppsFooter: "Timviz Master на телефоне",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Лондон",
    appCardButton: "Записаться",
    reviewTitle: "Отзывы",
    reviewsList: [
      ["Лучшая система записи", "Отличный опыт, легко записываться. Оплачивать процедуры удобно, а напоминания помогают не забывать о визите.", "Люси", "Лондон"],
    ...
    statsLabel: "записей создано на Timviz",
  ...
  uk: {
    ...
    heroTitle: "Записуйтеся на послуги поруч",
    heroText: "Усі послуги, які потрібні щодня, тепер в одному місці.",
    bookedToday: "записів створено сьогодні",
    recommended: "Рекомендовані",
    seeAll: "Дивитися всі →",
    appKicker: "Доступно для майстрів",
    appTitle: "Завантажте Timviz Master",
    appText: "Керуйте записами, послугами, клієнтами й графіком з телефона. Timviz Master доступний як мобільний застосунок.",
    appButton: "Завантажити Timviz Master",
    appSoon: "Timviz Master доступний як мобільний застосунок",
    appStore: "App Store",
    googlePlay: "Google Play",
    comingSoon: "Скоро",
    mobileAppsFooter: "Timviz Master на телефоні",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Лондон",
    appCardButton: "Записатися",
    reviewTitle: "Відгуки",
    reviewsList: [
      ["Найкраща система запису", "Чудовий досвід, легко записуватися. Оплачувати процедури зручно, а нагадування допомагають не забути про візит.", "Люсі", "Лондон"],
    ...
    statsLabel: "записів створено на Timviz",
  ...
  en: {
    ...
    bookedToday: "appointments made today",
    recommended: "Recommended",
    seeAll: "See all →",
    appKicker: "Available for professionals",
    appTitle: "Download Timviz Master",
    appText: "Manage bookings, services, clients and your schedule from your phone. Timviz Master is available as a mobile app.",
    appButton: "Download Timviz Master",
    appSoon: "Timviz Master is available as a mobile app",
    appStore: "App Store",
    googlePlay: "Google Play",
    comingSoon: "Coming soon",
    mobileAppsFooter: "Timviz Master on your phone",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · London",
    appCardButton: "Book now",
    reviewTitle: "Reviews",
    reviewsList: [
      ["The best appointment system", "A smooth experience and easy booking. Payments are convenient, and reminders help me never miss a visit.", "Lucy", "London"],
      ["Easy search and appointment booking", "I can quickly find a great professional nearby and choose the right time without messaging.", "Dan", "New York"],
    ...
    statsLabel: "appointments made on Timviz",
...
Object.assign(copy, {
  fr: {
    ...
    bookedToday: "rendez-vous pris aujourd’hui",
    recommended: "Recommandés",
    seeAll: "Voir tout →",
    appKicker: "Disponible pour les pros",
    appTitle: "Téléchargez Timviz Master",
    appText: "Gérez vos rendez-vous, services, clients et planning depuis votre téléphone. Timviz Master est disponible comme application mobile.",
    appButton: "Télécharger Timviz Master",
    appSoon: "Timviz Master est disponible comme application mobile",
    comingSoon: "Bientôt disponible",
    mobileAppsFooter: "Timviz Master sur votre téléphone",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Londres",
    appCardButton: "Prendre RDV",
    reviewTitle: "Avis",
    reviewsList: [
      ["Le meilleur système de rendez-vous", "Une expérience fluide et une prise de rendez-vous simple. Les rappels m’aident à ne manquer aucun rendez-vous.", "Lucy", "Londres"],
      ["Recherche et rendez-vous faciles", "Je trouve rapidement un bon professionnel près de moi et je choisis l’heure sans messages.", "Dan", "New York"],
      ["Parfait pour les barbiers", "J’ai comparé plusieurs salons, vérifié les avis et pris rendez-vous en quelques clics.", "Dale", "Sydney"]
    ],
    ...
    statsLabel: "rendez-vous pris sur Timviz",
    ...
    businessText: "Gérez les rendez-vous, les services, les clients, les plannings d’équipe et le support depuis un seul espace.",
    more: "En savoir plus →",
    rating: "Excellent 5/5",
  ...
  pl: {
    ...
    heroTitle: "Umawiaj usługi w pobliżu",
    heroText: "Codzienne usługi w jednym miejscu.",
    bookedToday: "wizyt umówiono dzisiaj",
    recommended: "Polecane",
    seeAll: "Zobacz wszystkie →",
    appKicker: "Dostępne dla specjalistów",
    appTitle: "Pobierz Timviz Master",
    appText: "Zarządzaj wizytami, usługami, klientami i grafikiem z telefonu. Timviz Master jest dostępny jako aplikacja mobilna.",
    appButton: "Pobierz Timviz Master",
    appSoon: "Timviz Master jest dostępny jako aplikacja mobilna",
    comingSoon: "Wkrótce",
    mobileAppsFooter: "Timviz Master na telefonie",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Londyn",
    appCardButton: "Umów wizytę",
    reviewTitle: "Opinie",
    reviewsList: [
      ["Najlepszy system zapisów", "Płynne doświadczenie i łatwe umawianie wizyt. Przypomnienia pomagają mi nie przegapić wizyty.", "Lucy", "Londyn"],
      ["Łatwe wyszukiwanie i zapisy", "Szybko znajduję dobrego specjalistę w pobliżu i wybieram termin bez pisania wiadomości.", "Dan", "Nowy Jork"],
      ["Idealne dla barberów", "Porównałem kilka barber shopów, sprawdziłem opinie i umówiłem wizytę w kilka kliknięć.", "Dale", "Sydney"]
    ],
    ...
    statsLabel: "wizyt umówiono w Timviz",
    partners: "firm partnerskich",
    countries: "krajów używa Timviz",
    users: "użytkowników Timviz",
    businessTitle: "Timviz dla biznesu",
    businessText: "Zarządzaj wizytami, usługami, klientami, grafikami zespołu i obsługą z jednego miejsca.",
  ...
  cs: {
    ...
    heroTitle: "Objednejte si služby poblíž",
    heroText: "Každodenní služby na jednom místě.",
    bookedToday: "termínů dnes vytvořeno",
    recommended: "Doporučené",
    seeAll: "Zobrazit vše →",
    appKicker: "Dostupné pro profesionály",
    appTitle: "Stáhněte si Timviz Master",
    appText: "Spravujte objednávky, služby, klienty a rozvrh z telefonu. Timviz Master je dostupný jako mobilní aplikace.",
    appButton: "Stáhnout Timviz Master",
    appSoon: "Timviz Master je dostupný jako mobilní aplikace",
    comingSoon: "Již brzy",
    mobileAppsFooter: "Timviz Master v telefonu",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Londýn",
    appCardButton: "Objednat se",
    reviewTitle: "Recenze",
    reviewsList: [
      ["Nejlepší systém objednání", "Plynulé používání a snadné objednání. Připomenutí mi pomáhají nezmeškat návštěvu.", "Lucy", "Londýn"],
      ["Snadné hledání a objednání", "Rychle najdu dobrého profesionála poblíž a vyberu čas bez psaní zpráv.", "Dan", "New York"],
      ["Perfektní pro barbery", "Porovnal jsem několik barber shopů, zkontroloval recenze a objednal se na pár kliknutí.", "Dale", "Sydney"]
    ],
    statsTitle: "Lepší platforma pro služby na objednávku",
    statsText: "Jedno řešení pro klienty, profesionály a majitele firem.",
    statsLabel: "termínů vytvořeno v Timviz",
    partners: "partnerských firem",
    countries: "zemí používá Timviz",
    users: "uživatelů Timviz",
    businessTitle: "Timviz pro firmy",
    businessText: "Spravujte termíny, služby, klienty, rozvrhy týmu a podporu z jednoho prostoru.",
    more: "Zjistit více →",
    rating: "Výborně 5/5",
  ...
  es: {
    ...
    heroTitle: "Pide citas cerca",
    heroText: "Servicios diarios, todos en un solo lugar.",
    bookedToday: "citas creadas hoy",
    recommended: "Recomendados",
    seeAll: "Ver todo →",
    appKicker: "Disponible para profesionales",
    appTitle: "Descarga Timviz Master",
    appText: "Gestiona citas, servicios, clientes y horarios desde el teléfono. Timviz Master está disponible como app móvil.",
    appButton: "Descargar Timviz Master",
    appSoon: "Timviz Master está disponible como app móvil",
    comingSoon: "Próximamente",
    mobileAppsFooter: "Timviz Master en tu teléfono",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · Londres",
    appCardButton: "Pedir cita",
    reviewTitle: "Reseñas",
    reviewsList: [
      ["El mejor sistema de citas", "Una experiencia fluida y una cita sencilla. Los recordatorios me ayudan a no perder ninguna visita.", "Lucy", "Londres"],
      ["Búsqueda y cita fáciles", "Encuentro rápido un buen profesional cerca y elijo la hora sin mensajes.", "Dan", "Nueva York"],
      ["Perfecto para barberos", "Comparé varias barberías, revisé reseñas y pedí cita en pocos clics.", "Dale", "Sídney"]
    ],
    ...
    statsLabel: "citas creadas en Timviz",
    partners: "empresas asociadas",
    countries: "países usan Timviz",
    users: "usuarios de Timviz",
    businessTitle: "Timviz para negocios",
    businessText: "Gestiona citas, servicios, clientes, horarios del equipo y soporte desde un solo espacio.",
  ...
  de: {
    ...
    bookedToday: "Termine heute erstellt",
    recommended: "Empfohlen",
    seeAll: "Alle ansehen →",
    appKicker: "Für Profis verfügbar",
    appTitle: "Timviz Master herunterladen",
    appText: "Verwalten Sie Termine, Leistungen, Kunden und Ihren Zeitplan direkt vom Telefon. Timviz Master ist als mobile App verfügbar.",
    appButton: "Timviz Master laden",
    appSoon: "Timviz Master ist als mobile App verfügbar",
    comingSoon: "Demnächst",
    mobileAppsFooter: "Timviz Master auf dem Telefon",
    appStore: "App Store",
    googlePlay: "Google Play",
    appCardTitle: "Trendy Studio",
    appCardMeta: "5.0 ★★★★★ · London",
    appCardButton: "Termin buchen",
    reviewTitle: "Bewertungen",
    reviewsList: [
      ["Das beste Terminsystem", "Eine reibungslose Erfahrung und einfache Terminbuchung. Erinnerungen helfen mir, keinen Termin zu verpassen.", "Lucy", "London"],
      ["Einfache Suche und Terminbuchung", "Ich finde schnell einen guten Profi in der Nähe und wähle die passende Zeit ohne Nachrichten.", "Dan", "New York"],
      ["Perfekt für Barber", "Ich habe mehrere Barbershops verglichen, Bewertungen geprüft und in wenigen Klicks einen Termin gebucht.", "Dale", "Sydney"]
    ],
    statsTitle: "Eine bessere Plattform für Terminservices",
    statsText: "Eine Lösung für Kunden, Profis und Unternehmensinhaber.",
    statsLabel: "Termine auf Timviz erstellt",
    partners: "Partnerunternehmen",
    countries: "Länder nutzen Timviz",
    users: "Timviz Nutzer",
    businessTitle: "Timviz für Unternehmen",
    businessText: "Verwalten Sie Termine, Leistungen, Kunden, Teampläne und Support in einem Arbeitsbereich.",
    more: "Mehr erfahren →",
  ...
  return (
    <main className="public-home">
      ...
      <section className="public-app-section" id="app">
        ...
        <div className="public-phone-stack" aria-hidden="true">
          <div className="public-phone-card">
            ...
            <span className="public-phone-button">{String(t.appCardButton)}</span>
          </div>
      ...
      <section className="public-cities-section">
        <div className="public-country-tabs" role="region" tabIndex={0} aria-label={String(t.citiesTitle)}>
