...
const bookingSuccessCopy: Record<SiteLanguage, BookingSuccessCopy> = withEnglishFallback<BookingSuccessCopy>({
  ru: {
    ...
    heroText: "Запись сохранена. Следом сюда можно подключить Telegram-напоминания, оплату и управление статусами визита.",
  ...
  uk: {
    ...
    heroText: "Запис збережено. Далі сюди можна підключити Telegram-нагадування, оплату та керування статусами візиту.",
  ...
  en: {
    ...
    heroText: "Your appointment has been saved. Telegram reminders, payments and visit status management can plug into this step next.",
    pendingHeroText: "Your appointment request was sent to the professional. Once confirmed, the visit becomes active.",
    bookingNumber: "Appointment number",
    service: "Service",
    date: "Date",
    time: "Time",
    client: "Client",
...
Object.assign(bookingSuccessCopy, {
  fr: {
    ...
    heroText: "Votre rendez-vous est enregistré. Les rappels Telegram, les paiements et la gestion du statut pourront être ajoutés à cette étape.",
    pendingHeroText: "Votre demande de rendez-vous a été envoyée au professionnel. Après confirmation, la visite deviendra active.",
    bookingNumber: "Numéro de rendez-vous",
    service: "Service",
    date: "Date",
    time: "Heure",
    client: "Client",
  ...
  pl: {
    ...
    heroText: "Wizyta została zapisana. W tym kroku można później dodać przypomnienia Telegram, płatności i zarządzanie statusem wizyty.",
    pendingHeroText: "Zgłoszenie wizyty zostało wysłane. Po potwierdzeniu wizyta stanie się aktywna.",
    bookingNumber: "Numer wizyty",
    service: "Usługa",
    date: "Data",
    time: "Godzina",
    client: "Klient",
  ...
  cs: {
    ...bookingSuccessCopy.en,
    locale: "cs-CZ",
    eyebrow: "Termín potvrzen",
    pendingEyebrow: "Žádost odeslána",
    heroText: "Termín byl uložen. V tomto kroku lze později přidat Telegram připomenutí, platby a správu stavu návštěvy.",
    pendingHeroText: "Žádost o termín byla odeslána. Po potvrzení bude návštěva aktivní.",
    bookingNumber: "Číslo termínu",
    service: "Služba",
    date: "Datum",
    time: "Čas",
    client: "Klient",
  ...
  es: {
    ...
    heroText: "Tu cita se ha guardado. En este paso se podrán añadir recordatorios de Telegram, pagos y gestión del estado de la visita.",
    pendingHeroText: "Tu solicitud de cita fue enviada. Cuando se confirme, la visita estará activa.",
    bookingNumber: "Número de cita",
    service: "Servicio",
    date: "Fecha",
    time: "Hora",
    client: "Cliente",
  ...
  de: {
    ...
    heroText: "Dein Termin wurde gespeichert. Telegram-Erinnerungen, Zahlungen und Statusverwaltung können später hier ergänzt werden.",
    pendingHeroText: "Deine Terminanfrage wurde gesendet. Nach Bestätigung wird der Besuch aktiv.",
    bookingNumber: "Terminnummer",
    service: "Leistung",
    date: "Datum",
    time: "Zeit",
    client: "Kunde",
