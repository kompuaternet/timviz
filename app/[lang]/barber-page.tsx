...
const copy: Record<SiteLanguage, Copy> = {
  uk: {
    ...
    subtitle: "Керуйте записами клієнтів, графіком і послугами без хаосу в месенджерах",
    ...
    problems: [
      { title: "Клієнти пишуть в Instagram", text: "Записи залишаються в чатах і їх легко втратити." },
      { title: "Записи губляться", text: "Складно зрозуміти хто записаний і на який час." },
      ...
      { title: "Немає контролю графіка", text: "Складно бачити вільні вікна." }
    ],
    ...
    solutionCards: [
      ...
      { title: "Послуги з ціною", text: "Клієнт бачить вартість і тривалість." },
      { title: "Графік роботи", text: "Налаштуйте робочі дні." },
      { title: "Telegram", text: "Отримуйте записи миттєво." },
      { title: "Сторінка запису", text: "Клієнти записуються самі." }
    ],
    nicheTitle: "Ідеально для барберів",
    nicheText: "Timviz підходить для щільного графіка барбершопу та різних форматів чоловічих послуг.",
    nicheItems: ["чоловічі стрижки", "борода", "комплексні послуги", "fade", "укладки"],
    ...
    compareLeft: [
      ...
      "ручні уточнення часу",
      "накладки у графіку",
      "втрачені повідомлення"
    ],
    compareRight: [
      "онлайн-запис клієнтів",
      "календар записів у реальному часі",
      "послуги з ціною і тривалістю",
      "швидкі Telegram-сповіщення"
    ],
