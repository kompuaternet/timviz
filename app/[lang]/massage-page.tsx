...
const copy: Record<SiteLanguage, Copy> = {
  ...
  ru: {
    ...
    nicheText: "Timviz подходит для частной практики и студий с сеансами разной длительности.",
    nicheItems: ["классический массаж", "релакс массаж", "лечебный массаж", "антицеллюлитный", "спортивный массаж", "реабилитация"],
    ...
    seoParagraphs: [
      "Timviz помогает массажистам вести онлайн-запись клиентов и управлять загруженным графиком.",
      "Сервис объединяет услуги, длительность, цены и календарь в одном кабинете.",
      "Это удобный способ снизить хаос в чатах и повысить конверсию в реальные визиты."
    ],
    faqTitle: "FAQ",
    faq: [
