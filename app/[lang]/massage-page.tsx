...
const ukSeoParagraphs = [
  ...
  "Частий запит спеціалістів — запис клієнтів масаж без постійних дзвінків і нескінченних уточнень. У Timviz клієнт отримує зрозумілу сторінку запису, де бачить доступні послуги, тривалість і параметр послуги, а після вибору часу запис з'являється у вашому робочому кабінеті автоматично. Запис клієнтів онлайн стає передбачуваним процесом: менше помилок у часі, менше випадкових пропусків і менше перенесень через непорозуміння. Для масажиста це означає стабільніший потік відвідувань і менше ручної адміністративної роботи протягом усього тижня.",
  ...
  "Якщо ви працюєте з різними напрямками, наприклад лікувальний масаж, антицелюлітний, реабілітація або релакс-сесії, важливо мати гнучке керування послугами. Саме тут програма для масажиста дає відчутний результат: кожна послуга має власну тривалість і формат послуги, а клієнт бачить ці параметри до бронювання. Це знижує кількість непорозумінь та запитань у діректі. Коли онлайн запис масаж налаштований прозоро, клієнту простіше прийняти рішення і завершити бронювання. Для майстра це означає вищу конверсію з переглядів у реальні записи та більш прогнозований дохід щотижня.",
...
const copy: Record<SiteLanguage, Copy> = {
  uk: {
    ...
    solutionCards: [
      ...
      { title: "Послуги з тривалістю", text: "Клієнт бачить час і формат послуги." },
    ...
    nicheSample: "Класичний масаж — 60 хв",
    dayScenarioTitle: "Сценарій робочого дня масажиста",
    dayScenarioItems: [
      "09:00 — Лікувальний масаж — 45 хв: ранковий короткий слот для точного старту дня.",
      "10:00 — Класичний масаж — 60 хв: базовий сеанс без накладок у календарі.",
      "12:00 — Релакс масаж — 90 хв: довга процедура з буфером між записами.",
      "15:00 — Спортивний масаж — 60 хв: щільний денний слот з контрольованим таймінгом.",
      "18:00 — Антицелюлітний масаж — 75 хв: вечірній запис закривається онлайн."
    ],
    ...
    trustCards: [
      ...
      },
      {
        ...
        text: "Клієнт бронює час самостійно, а майстер отримує структурований візит із форматом послуги і тривалістю."
      },
      {
    ...
    altServices: "Послуги та тривалість масажиста у Timviz",
  ...
  ru: {
    ...
    solutionCards: [
      ...
      { title: "Услуги с длительностью", text: "Клиент видит время и формат услуги." },
    ...
    nicheItems: [
      "Классический массаж — 60 мин: базовый слот для ежедневной загрузки.",
      "Релакс массаж — 90 мин: длинный сеанс с корректным буфером.",
      "Лечебный массаж — 45 мин: удобно планировать в середине дня.",
      "Спортивный массаж — 60 мин: запись с фиксированной длительностью.",
      "Реабилитационный сеанс — 90 мин: удобный формат для курсовых посещений."
    ],
    nicheSample: "Классический массаж — 60 мин",
    dayScenarioTitle: "Сценарий рабочего дня массажиста",
    dayScenarioItems: [
      "09:00 — Лечебный массаж — 45 мин: утренний слот с короткой длительностью.",
      "10:00 — Классический массаж — 60 мин: базовый прием без накладок.",
      "12:00 — Релакс массаж — 90 мин: длинный сеанс с автоматическим буфером.",
      "15:00 — Спортивный массаж — 60 мин: удобная запись в середине дня.",
      "18:00 — Антицеллюлитный массаж — 75 мин: вечерний слот бронируется онлайн."
    ],
    ...
    seoParagraphs: [
      ...
      "Если смотреть на развитие в долгую, системная запись повышает ценность сервиса в глазах клиента. Людям удобно, когда можно самостоятельно выбрать время, увидеть понятную параметр услуги и получить подтверждение без ожидания ответа в чате. Timviz формирует именно такой опыт: прозрачный, быстрый и профессиональный. За счёт этого растет доля повторных визитов и рекомендаций, а запись клиентов онлайн становится не разовой функцией, а устойчивым каналом роста для массажиста или студии.",
    ...
    faq: [
      ...
      { q: "Можно ли настроить длительность сеансов?", a: "Да, для каждой услуги задается отдельная длительность и формат услуги." },
      ...
      { q: "Подходит ли для разных типов массажа?", a: "Да, можно добавить разные виды массажа с разной длительностью и параметрами услуги." }
    ],
    ...
    altServices: "Услуги и длительность массажиста в Timviz",
  ...
  en: {
    ...
    solutionCards: [
      ...
      { title: "Duration-based services", text: "Clients see time and service details." },
    ...
    nicheSample: "Classic massage — 60 min",
    dayScenarioTitle: "Massage therapist day scenario",
    dayScenarioItems: [
      "09:00 — Therapeutic massage — 45 min: precise morning slot to start the day.",
      "10:00 — Classic massage — 60 min: core session with predictable timing.",
      "12:00 — Relax massage — 90 min: long treatment with automatic buffer handling.",
      "15:00 — Sports massage — 60 min: daytime slot optimized without overlaps.",
      "18:00 — Anti-cellulite massage — 75 min: evening booking captured online."
    ],
    ...
    seoParagraphs: [
      ...
      "Booking quality also impacts client trust. Clear service duration, visible service setup and reliable confirmations make the experience professional. Clients are more likely to return when booking is fast and predictable.",
    ...
    faq: [
      ...
      { q: "Can I set different session durations?", a: "Yes, each massage service can have its own duration and service details." },
