...
const copy: Record<SiteLanguage, Copy> = {
  ru: {
    ...
    nicheFitItems: ["гель-лак", "наращивание", "дизайн", "коррекция", "педикюр"],
    nicheFitSample: "Маникюр + гель-лак — 90 мин — 700 грн",
    seoBlockTitle: "Программа для записи клиентов для мастеров маникюра",
    seoParagraphs: [
      "Timviz помогает мастерам маникюра принимать онлайн-запись клиентов и держать расписание под контролем.",
      "Сервис объединяет календарь записей, услуги, цены и длительность процедур в одном кабинете.",
