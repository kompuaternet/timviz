...
const copy: Record<SiteLanguage, Copy> = {
  ...
  ru: {
    ...
    nicheText: "Timviz подходит для частных косметологов и студий с плотным расписанием процедур.",
    nicheItems: ["чистка лица", "пилинги", "инъекции", "уходовые процедуры", "аппаратная косметология"],
    ...
    seoParagraphs: [
      "Timviz помогает косметологам принимать онлайн-запись клиентов и держать расписание под контролем.",
      "Сервис объединяет процедуры, цены, длительность и календарь в одном кабинете.",
      "Это удобный способ уменьшить хаос в мессенджерах и повысить конверсию в реальные визиты."
    ],
    faqTitle: "FAQ",
    faq: [
