...
const planCopy = {
  ...
  fr: {
    ...
    renewsOn: "Ensuite",
    freeHint: "Forfait Free : 100 rendez-vous chaque mois. Premium débloque la réservation en ligne, Telegram, les rappels et le calendrier avancé.",
  ...
  pl: {
    ...
    renewsOn: "Dalej",
    freeHint: "Plan Free: 100 wizyt co miesiąc. Premium odblokowuje rezerwacje online, Telegram, przypomnienia i rozszerzony kalendarz.",
