...
const serviceModeGroups = [
  {
    ...
    fr: "Les clients viennent dans mon établissement",
    pl: "Klienci przychodzą do mojej lokalizacji",
    cs: "Klienti chodí na mou provozovnu",
    es: "Los clientes vienen a mi local",
    de: "Kunden kommen an meinen Standort"
  },
  {
    ru: "Я работаю с выездом к клиенту",
    uk: "Я працюю з виїздом до клієнта",
    en: "I work on-site at the client's location",
    fr: "Je me déplace chez le client",
    pl: "Pracuję u klienta",
    cs: "Pracuji u klienta",
    es: "Trabajo en la ubicación del cliente",
    de: "Ich arbeite vor Ort beim Kunden"
  },
  {
    ru: "Я предоставляю услуги онлайн",
    uk: "Я надаю послуги онлайн",
    en: "I provide services online",
    fr: "Je propose des services en ligne",
    pl: "Świadczę usługi online",
    cs: "Poskytuji služby online",
    es: "Presto servicios online",
    de: "Ich biete Online-Leistungen an"
  }
] as const;
...
const settingsExtras = {
  ...
  fr: {
    ...
    uploadPhotoFailed: "Impossible de téléverser la photo.",
    saveFailed: "Impossible d’enregistrer les réglages.",
    categoriesHint: "Choisissez une ou plusieurs catégories du catalogue.",
    joinRequestsTitle: "Demandes d’accès",
    joinRequestsText: "Approuvez les employés qui demandent l’accès à votre entreprise.",
    joinApprove: "Approuver",
    joinReject: "Refuser",
    joinEmpty: "Aucune nouvelle demande.",
    publicBookingTitle: "Lien public de réservation",
    publicBookingText: "Partagez ce lien avec les clients, publiez-le sur les réseaux et envoyez-le aux spécialistes.",
    publicBookingEnabled: "Réservation en ligne activée",
    publicBookingDisabled: "Réservation en ligne désactivée",
    copyLink: "Copier le lien",
    openLink: "Ouvrir la page",
    shareLink: "Partager",
    linkCopied: "Lien de réservation copié.",
    closeSettings: "Fermer les réglages",
    telegramTitle: "Bot Telegram Timviz",
    telegramConnected: "Bot connecté",
    telegramNotConnected: "Bot non connecté",
    telegramConnectButton: "Connecter Telegram",
    sectionGeneral: "Général",
    sectionOnlineBooking: "Réservation en ligne",
    sectionServices: "Services",
    sectionSchedule: "Planning",
    sectionTelegram: "Telegram",
    sectionAddress: "Adresse",
    onlineBookingSettingsTitle: "Réglages de réservation en ligne",
    bookingLinkTitle: "Lien de réservation",
    scheduleTitle: "Horaires de travail",
    scheduleOpenButton: "Ouvrir le planning",
    onboardingChecklistTitle: "Checklist de lancement",
    onboardingProgress: (done: number, total: number) => `${done} sur ${total} terminé`,
    onboardingStepServices: "Ajouter les services et prix",
    onboardingStepSchedule: "Configurer l’horaire",
    onboardingStepBooking: "Activer la réservation",
    onboardingStepPhoto: "Ajouter une photo",
    onboardingStepAddress: "Ajouter l’adresse",
    onboardingStepTelegram: "Connecter Telegram",
  ...
  pl: {
    ...
    uploadPhotoFailed: "Nie udało się przesłać zdjęcia.",
    saveFailed: "Nie udało się zapisać ustawień.",
    categoriesHint: "Wybierz jedną lub kilka kategorii z katalogu.",
    joinRequestsTitle: "Prośby o dołączenie",
    joinApprove: "Zatwierdź",
    joinReject: "Odrzuć",
    joinEmpty: "Brak nowych próśb.",
    publicBookingTitle: "Publiczny link do rezerwacji",
    publicBookingEnabled: "Rezerwacje online włączone",
    publicBookingDisabled: "Rezerwacje online wyłączone",
    copyLink: "Kopiuj link",
    openLink: "Otwórz stronę",
    shareLink: "Udostępnij",
    linkCopied: "Link do rezerwacji skopiowany.",
    closeSettings: "Zamknij ustawienia",
    telegramTitle: "Bot Telegram Timviz",
    telegramConnected: "Bot połączony",
    telegramNotConnected: "Bot niepołączony",
    telegramConnectButton: "Połącz Telegram",
    sectionGeneral: "Ogólne",
    sectionOnlineBooking: "Rezerwacje online",
    sectionServices: "Usługi",
    sectionSchedule: "Grafik",
    sectionTelegram: "Telegram",
    sectionAddress: "Adres",
    onlineBookingSettingsTitle: "Ustawienia rezerwacji online",
    bookingLinkTitle: "Link do rezerwacji",
    scheduleTitle: "Grafik pracy",
    scheduleOpenButton: "Otwórz grafik",
    onboardingChecklistTitle: "Lista startowa",
    onboardingProgress: (done: number, total: number) => `${done} z ${total} ukończono`,
    onboardingStepServices: "Dodaj usługi i ceny",
    onboardingStepSchedule: "Ustaw grafik pracy",
    onboardingStepBooking: "Włącz rezerwacje online",
    onboardingStepPhoto: "Dodaj zdjęcie firmy",
    onboardingStepAddress: "Dodaj adres",
    onboardingStepTelegram: "Połącz Telegram",
  ...
  cs: {
    ...
    sectionOnlineBooking: "Online rezervace",
    ...
    openLink: "Otevřít stránku",
    shareLink: "Sdílet",
    publicBookingEnabled: "Online rezervace zapnuty",
    publicBookingDisabled: "Online rezervace vypnuty",
  ...
  es: {
    sectionGeneral: "General",
    sectionOnlineBooking: "Reserva online",
    ...
    openLink: "Abrir página",
    shareLink: "Compartir",
    publicBookingEnabled: "Reserva online activada",
    publicBookingDisabled: "Reserva online desactivada",
  ...
  de: {
    ...
    sectionOnlineBooking: "Online-Buchung",
    ...
    shareLink: "Teilen",
    publicBookingEnabled: "Online-Buchung aktiviert",
    publicBookingDisabled: "Online-Buchung deaktiviert",
...
const planCopy = {
  ru: {
    ...
    freeHint: "Бесплатный тариф навсегда. Premium открывает онлайн-запись, Telegram, напоминания и расширенный календарь.",
    ...
    appointmentsFreeText: "Free доступен навсегда. В начале месяца доступные записи обновятся автоматически.",
  ...
  uk: {
    ...
    yearlyRenewal: "Premium Yearly · $29/year",
    monthlyRenewal: "Premium Monthly · $3/month",
    freeHint: "Безкоштовний тариф назавжди. Premium відкриває онлайн-запис, Telegram, нагадування та розширений календар.",
    ...
    appointmentsFreeText: "Free доступний назавжди. На початку місяця доступні записи оновляться автоматично.",
  ...
  en: {
    ...
    yearlyRenewal: "Premium Yearly · $29/year",
    monthlyRenewal: "Premium Monthly · $3/month",
    freeHint: "Free plan forever. Premium unlocks online booking, Telegram, reminders, and the advanced calendar.",
    ...
    appointmentsFreeText: "Free is available forever. Available appointments refresh automatically at the start of each month.",
  ...
  fr: {
    ...
    canceled: "Annulé",
    nextDate: "Accès jusqu'au",
    trialUntil: "Essai jusqu'au",
    renewsOn: "Ensuite",
    freeHint: "Forfait Free à vie. Premium débloque la réservation en ligne, Telegram, les rappels et le calendrier avancé.",
    premiumHint: "Premium est actif pour le logiciel Timviz. Vous pouvez annuler l'abonnement à tout moment.",
    trialHintMonthly: "Après l'essai, l'abonnement continue en Premium Monthly pour $3/month. Vous pouvez annuler à tout moment.",
    ...
    appointmentsFreeText: "Free est disponible à vie. Les rendez-vous disponibles se renouvellent automatiquement au début de chaque mois.",
    appointmentsPremiumText: "Premium ne consomme pas de crédits de rendez-vous : créez des réservations sans limite.",
    appointmentsRemaining: "Restants",
    appointmentsUsed: "Utilisés",
    appointmentsLimit: "Limite",
    limitEndedTitle: "Les rendez-vous du mois sont épuisés",
    limitEndedText: "Premium débloque les rendez-vous illimités, la réservation en ligne, Telegram et les rappels.",
    lockedTitle: "Cette fonctionnalité est disponible avec Premium",
    lockedText: "Free couvre le suivi de base. Premium débloque la réservation en ligne, les notifications Telegram, les rappels clients et le calendrier avancé."
  },
  pl: {
    eyebrow: "Plan",
    title: "Aktualny plan",
    ...
    active: "Aktywny",
    past_due: "Wymagana płatność",
    canceled: "Anulowany",
    nextDate: "Dostęp do",
    trialUntil: "Okres próbny do",
    renewsOn: "Dalej",
    freeHint: "Plan Free na zawsze. Premium odblokowuje rezerwacje online, Telegram, przypomnienia i rozszerzony kalendarz.",
    premiumHint: "Premium jest aktywny dla oprogramowania Timviz. Subskrypcję można anulować w dowolnym momencie.",
    trialHintMonthly: "Po okresie próbnym subskrypcja będzie kontynuowana jako Premium Monthly za $3/month. Możesz anulować w dowolnym momencie.",
    ...
    appointmentsFreeText: "Free jest dostępny na zawsze. Dostępne wizyty odnawiają się automatycznie na początku miesiąca.",
    appointmentsPremiumText: "Premium nie zużywa kredytów wizyt: twórz rezerwacje bez limitu.",
    appointmentsRemaining: "Pozostało",
    appointmentsUsed: "Wykorzystano",
    appointmentsLimit: "Limit",
    limitEndedTitle: "Wizyty na ten miesiąc zostały wykorzystane",
    limitEndedText: "Premium odblokowuje nielimitowane wizyty, rezerwacje online, Telegram i przypomnienia.",
    lockedTitle: "Ta funkcja jest dostępna w Premium",
    lockedText: "Free obejmuje podstawową obsługę. Premium odblokowuje rezerwacje online, powiadomienia Telegram, przypomnienia dla klientów i rozszerzony kalendarz."
  },
  cs: {
    eyebrow: "Tarif",
    ...
    active: "Aktivní",
    past_due: "Je nutná platba",
    canceled: "Zrušeno",
    nextDate: "Přístup do",
    trialUntil: "Zkušební období do",
    renewsOn: "Dále",
    ...
    appointmentsLimit: "Limit",
    limitEndedTitle: "Rezervace pro tento měsíc jsou vyčerpány",
    lockedTitle: "Tato funkce je dostupná v Premium"
  },
  es: {
    eyebrow: "Plan",
    title: "Plan actual",
    ...
    appointmentsLimit: "Límite",
    limitEndedTitle: "Las citas de este mes se han agotado",
    lockedTitle: "Esta función está disponible en Premium"
  },
  de: {
    eyebrow: "Tarif",
    ...
    trialing: "Testphase",
    active: "Aktiv",
    past_due: "Zahlung erforderlich",
    canceled: "Gekündigt",
    nextDate: "Zugang bis",
    trialUntil: "Testphase bis",
    renewsOn: "Danach",
    ...
    appointmentsLimit: "Limit",
    limitEndedTitle: "Buchungen für diesen Monat sind aufgebraucht",
    lockedTitle: "Diese Funktion ist in Premium verfügbar"
  }
} as const;
...
export default function SettingsView({ initialData, onboardingCta, initialSection }: SettingsViewProps) {
  ...
  const copy = {
    ...settingsExtras.en,
    ...((settingsExtras as unknown as Record<string, Partial<typeof settingsExtras.en>>)[language] ?? {})
  } as typeof settingsExtras.en;
  const planText = {
    ...planCopy.en,
    ...((planCopy as unknown as Record<string, Partial<typeof planCopy.en>>)[language] ?? {})
  } as typeof planCopy.en;
