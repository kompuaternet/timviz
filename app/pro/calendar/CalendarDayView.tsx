...
type CalendarJoinRequestNotification = {
  id: string;
  createdAt: string;
  role: string;
  professionalId: string;
...
const BASE_CALENDAR_TEXT: Record<BaseProLanguage, {
  ...
  ru: {
    ...
    withoutClientHint: "Быстрая запись без карточки клиента.",
    ...
    joinRequestTitle: "Новый запрос в команду",
    openJoinRequests: "Открыть запросы",
  ...
  uk: {
    ...
    withoutClientHint: "Швидкий запис без картки клієнта.",
    ...
    joinRequestTitle: "Новий запит у команду",
    openJoinRequests: "Відкрити запити",
  ...
  en: {
    ...
    withoutClientHint: "Quick booking without a client card.",
    ...
    joinRequestTitle: "New team join request",
    openJoinRequests: "Open requests",
...
const CALENDAR_TEXT: Record<AppLanguage, CalendarCopy> = {
  ...
  en: BASE_CALENDAR_TEXT.en,
  fr: {
    ...BASE_CALENDAR_TEXT.en,
    today: "Aujourd’hui",
    day: "Jour",
    threeDays: "3 jours",
    week: "Semaine",
    month: "Mois",
    daySchedule: "Planning du jour",
    waitlist: "Liste d’attente",
    closed: "fermé",
    closedBySchedule: "Fermé selon l’horaire",
    services: "services",
    dailyCalendar: "calendrier du jour",
    visits: "visites",
    selected: "Sélectionné",
    masterFallback: "Professionnel",
    back: "Retour",
    quickNewVisit: "Nouveau rendez-vous",
    quickBlockBusy: "Bloquer ce créneau",
    quickAddOffTime: "Ajouter une indisponibilité",
    newVisitTitle: "Nouveau rendez-vous",
    customer: "Client",
    ...
    addAnotherService: "AJOUTER UN SERVICE ＋",
    ...
    withoutClient: "Sans client",
    newClient: "Nouveau client",
    hideForm: "Masquer le formulaire",
    addClientTitle: "Ajouter un client",
    clientName: "Nom du client",
    phone: "Téléphone",
    addAndChoose: "Ajouter et choisir",
    clients: "Clients",
    allTeam: "Toute l’équipe",
    chosenMasters: (count) => `Sélectionné : ${count}`,
    showAllTeam: "Afficher toute l’équipe",
    selectedMasters: "Spécialistes sélectionnés",
    visitsCountLabel: (count) => `${count} visites`,
    clientNotFound: "Client introuvable",
    clientsEmpty: "La liste de clients est vide",
    blockedTimeFallback: "Temps bloqué",
    walkInClient: "Client sans fiche",
    saveTime: "Enregistrer le créneau",
    deleteBlock: "Supprimer le blocage",
    deleteVisit: "Supprimer le rendez-vous",
    service: "Service",
    specialist: "Spécialiste",
    visitDateTime: "Date et heure",
    attendanceStatus: "Statut du rendez-vous",
    attendancePending: "En attente",
    attendanceConfirmed: "Confirmé",
    attendanceArrived: "Arrivé",
    attendanceNoShow: "Absent",
    price: "Prix",
    notesLabel: "Note",
    ...
    saveVisit: "Enregistrer le rendez-vous",
    deleteCancel: "Non",
    deleteConfirm: "Oui, supprimer",
    chooseSpecialist: "Choisir un spécialiste",
    refresh: "Actualiser",
    notifications: "Notifications",
    pendingOnlineBookings: "Réservations en attente",
    pendingJoinRequests: "Demandes d’équipe",
    notificationsMessages: "Invitations et messages",
    archivedOnlineBookings: "Archive",
    notificationsEmpty: "Aucune nouvelle mise à jour.",
    ...
    onlineBookingStatusPending: "En attente de confirmation",
    onlineBookingStatusConfirmed: "Confirmé",
    onlineBookingStatusCancelled: "Annulé"
  },
  pl: {
    ...BASE_CALENDAR_TEXT.en,
    today: "Dzisiaj",
    ...
    week: "Tydzień",
    month: "Miesiąc",
    daySchedule: "Plan dnia",
    waitlist: "Lista oczekujących",
    closed: "zamknięte",
    closedBySchedule: "Zamknięte według grafiku",
    services: "usługi",
    dailyCalendar: "kalendarz dzienny",
    visits: "wizyty",
    selected: "Wybrano",
    masterFallback: "Specjalista",
    back: "Wstecz",
    quickNewVisit: "Nowa wizyta",
    quickBlockBusy: "Zablokuj ten czas",
    quickAddOffTime: "Dodaj niedostępność",
    newVisitTitle: "Nowa wizyta",
    customer: "Klient",
    chooseService: "Wybierz usługę",
    start: "Start",
    end: "Koniec",
    primaryService: "Usługa",
    additionalService: "Dodatkowa usługa",
    addAnotherService: "DODAJ USŁUGĘ ＋",
    removeService: "Usuń usługę",
    total: "Razem",
    payable: "Do zapłaty",
    cancelUpper: "ANULUJ",
    saveUpper: "ZAPISZ",
    savingUpper: "ZAPISYWANIE",
    searchPlaceholder: "Szukaj",
    chooseClient: "Wybierz klienta",
    clientNameOrPhone: "Imię lub telefon",
    withoutClient: "Bez klienta",
    newClient: "Nowy klient",
    hideForm: "Ukryj formularz",
    addClientTitle: "Dodaj klienta",
    clientName: "Imię klienta",
    phone: "Telefon",
    addAndChoose: "Dodaj i wybierz",
    clients: "Klienci",
    allTeam: "Cały zespół",
    chosenMasters: (count) => `Wybrano: ${count}`,
    showAllTeam: "Pokaż cały zespół",
    selectedMasters: "Wybrani specjaliści",
    visitsCountLabel: (count) => `${count} wizyt`,
    clientNotFound: "Nie znaleziono klienta",
    clientsEmpty: "Lista klientów jest pusta",
    blockedTimeFallback: "Zablokowany czas",
    walkInClient: "Klient bez karty",
    saveTime: "Zapisz czas",
    deleteBlock: "Usuń blokadę",
    deleteVisit: "Usuń wizytę",
    service: "Usługa",
    specialist: "Specjalista",
    visitDateTime: "Data i godzina",
    attendanceStatus: "Status wizyty",
    attendancePending: "Oczekuje",
    attendanceConfirmed: "Potwierdzona",
    attendanceArrived: "Przybył",
    attendanceNoShow: "Nie przyszedł",
    price: "Cena",
    notesLabel: "Notatka",
    ...
    pendingOnlineBookings: "Rezerwacje oczekujące",
    pendingJoinRequests: "Prośby o dołączenie",
    notificationsMessages: "Zaproszenia i wiadomości",
    archivedOnlineBookings: "Archiwum",
    notificationsEmpty: "Brak nowych aktualizacji.",
    ...
    onlineBookingStatusPending: "Oczekuje na potwierdzenie",
    onlineBookingStatusConfirmed: "Potwierdzona",
    onlineBookingStatusCancelled: "Anulowana"
  },
  cs: {
    ...BASE_CALENDAR_TEXT.en,
    today: "Dnes",
    ...
    week: "Týden",
    month: "Měsíc",
    daySchedule: "Denní rozvrh",
    waitlist: "Čekací listina",
    closed: "zavřeno",
    closedBySchedule: "Zavřeno podle rozvrhu",
    services: "služby",
    dailyCalendar: "denní kalendář",
    visits: "návštěvy",
    selected: "Vybráno",
    masterFallback: "Specialista",
    back: "Zpět",
    quickNewVisit: "Nová návštěva",
    quickBlockBusy: "Blokovat tento čas",
    quickAddOffTime: "Přidat nedostupnost",
    newVisitTitle: "Nová návštěva",
    customer: "Klient",
    chooseService: "Vyberte službu",
    start: "Začátek",
    end: "Konec",
    primaryService: "Služba",
    additionalService: "Další služba",
    addAnotherService: "PŘIDAT SLUŽBU ＋",
    removeService: "Odebrat službu",
    total: "Celkem",
    payable: "K úhradě",
    cancelUpper: "ZRUŠIT",
    saveUpper: "ULOŽIT",
    savingUpper: "UKLÁDÁNÍ",
    ...
    addClientTitle: "Přidat klienta",
    clientName: "Jméno klienta",
    phone: "Telefon",
    addAndChoose: "Přidat a vybrat",
    clients: "Klienti",
    allTeam: "Celý tým",
    chosenMasters: (count) => `Vybráno: ${count}`,
    showAllTeam: "Zobrazit celý tým",
    selectedMasters: "Vybraní specialisté",
    visitsCountLabel: (count) => `${count} návštěv`,
    clientNotFound: "Klient nenalezen",
    clientsEmpty: "Seznam klientů je prázdný",
    blockedTimeFallback: "Blokovaný čas",
    walkInClient: "Klient bez karty",
    saveTime: "Uložit čas",
    deleteBlock: "Smazat blokaci",
    deleteVisit: "Smazat návštěvu",
    service: "Služba",
    specialist: "Specialista",
    visitDateTime: "Datum a čas",
    attendanceStatus: "Stav návštěvy",
    attendancePending: "Čeká",
    attendanceConfirmed: "Potvrzeno",
    attendanceArrived: "Dorazil",
    attendanceNoShow: "Nepřišel",
    price: "Cena",
    notesLabel: "Poznámka",
    ...
    chooseSpecialist: "Vybrat specialistu",
    refresh: "Obnovit",
    notifications: "Oznámení",
    pendingOnlineBookings: "Čekající online rezervace",
    pendingJoinRequests: "Žádosti o připojení",
    notificationsMessages: "Pozvánky a zprávy",
    archivedOnlineBookings: "Archiv",
    notificationsEmpty: "Zatím nejsou žádné nové aktualizace.",
    ...
    onlineBookingStatusPending: "Čeká na potvrzení",
    onlineBookingStatusConfirmed: "Potvrzeno",
    onlineBookingStatusCancelled: "Zrušeno"
  },
  es: {
    ...BASE_CALENDAR_TEXT.en,
    today: "Hoy",
    ...
    closed: "cerrado",
    closedBySchedule: "Cerrado por horario",
    services: "servicios",
    dailyCalendar: "calendario diario",
    visits: "visitas",
    selected: "Seleccionado",
    masterFallback: "Profesional",
    back: "Atrás",
    quickNewVisit: "Nueva visita",
    quickBlockBusy: "Bloquear este horario",
    quickAddOffTime: "Añadir indisponibilidad",
    newVisitTitle: "Nueva visita",
    customer: "Cliente",
    chooseService: "Elegir servicio",
    start: "Inicio",
    end: "Fin",
    primaryService: "Servicio",
    additionalService: "Servicio adicional",
    addAnotherService: "AÑADIR SERVICIO ＋",
    ...
    phone: "Teléfono",
    addAndChoose: "Añadir y elegir",
    clients: "Clientes",
    allTeam: "Todo el equipo",
    chosenMasters: (count) => `Seleccionados: ${count}`,
    showAllTeam: "Mostrar todo el equipo",
    selectedMasters: "Especialistas seleccionados",
    visitsCountLabel: (count) => `${count} visitas`,
    clientNotFound: "Cliente no encontrado",
    clientsEmpty: "La lista de clientes está vacía",
    blockedTimeFallback: "Horario bloqueado",
    walkInClient: "Cliente sin ficha",
    saveTime: "Guardar horario",
    deleteBlock: "Eliminar bloqueo",
    deleteVisit: "Eliminar visita",
    service: "Servicio",
    specialist: "Especialista",
    visitDateTime: "Fecha y hora",
    attendanceStatus: "Estado de la visita",
    attendancePending: "Pendiente",
    attendanceConfirmed: "Confirmada",
    attendanceArrived: "Llegó",
    ...
    pendingOnlineBookings: "Reservas pendientes",
    pendingJoinRequests: "Solicitudes de equipo",
    notificationsMessages: "Invitaciones y mensajes",
    archivedOnlineBookings: "Archivo",
    notificationsEmpty: "Aún no hay actualizaciones.",
    ...
    onlineBookingStatusPending: "Esperando confirmación",
    onlineBookingStatusConfirmed: "Confirmada",
    onlineBookingStatusCancelled: "Cancelada"
  },
  de: {
    ...BASE_CALENDAR_TEXT.en,
    today: "Heute",
    ...
    waitlist: "Warteliste",
    closed: "geschlossen",
    closedBySchedule: "Laut Zeitplan geschlossen",
    services: "Leistungen",
    dailyCalendar: "Tageskalender",
    visits: "Besuche",
    selected: "Ausgewählt",
    masterFallback: "Spezialist",
    back: "Zurück",
    quickNewVisit: "Neuer Termin",
    quickBlockBusy: "Diese Zeit blockieren",
    quickAddOffTime: "Nicht verfügbare Zeit hinzufügen",
    newVisitTitle: "Neuer Termin",
    customer: "Kunde",
    chooseService: "Leistung wählen",
    start: "Start",
    end: "Ende",
    primaryService: "Leistung",
    additionalService: "Zusätzliche Leistung",
    addAnotherService: "LEISTUNG HINZUFÜGEN ＋",
    removeService: "Leistung entfernen",
    total: "Gesamt",
    payable: "Zu zahlen",
    cancelUpper: "ABBRECHEN",
    saveUpper: "SPEICHERN",
    savingUpper: "SPEICHERN",
    searchPlaceholder: "Suche",
    chooseClient: "Kunden wählen",
    clientNameOrPhone: "Name oder Telefon",
    withoutClient: "Ohne Kunde",
    newClient: "Neuer Kunde",
    hideForm: "Formular ausblenden",
    addClientTitle: "Kunden hinzufügen",
    clientName: "Kundenname",
    phone: "Telefon",
    addAndChoose: "Hinzufügen und wählen",
    clients: "Kunden",
    allTeam: "Ganzes Team",
    chosenMasters: (count) => `Ausgewählt: ${count}`,
    showAllTeam: "Ganzes Team anzeigen",
    selectedMasters: "Ausgewählte Spezialisten",
    visitsCountLabel: (count) => `${count} Besuche`,
    clientNotFound: "Kunde nicht gefunden",
    clientsEmpty: "Kundenliste ist leer",
    blockedTimeFallback: "Blockierte Zeit",
    walkInClient: "Kunde ohne Karte",
    saveTime: "Zeit speichern",
    deleteBlock: "Blockierung löschen",
    deleteVisit: "Termin löschen",
    service: "Leistung",
    specialist: "Spezialist",
    visitDateTime: "Datum und Uhrzeit",
    attendanceStatus: "Terminstatus",
    attendancePending: "Ausstehend",
    attendanceConfirmed: "Bestätigt",
    attendanceArrived: "Erschienen",
    attendanceNoShow: "Nicht erschienen",
    price: "Preis",
    notesLabel: "Notiz",
    ...
    changeClient: "Kunden ändern",
    saveVisit: "Termin speichern",
    deleteCancel: "Nein",
    deleteConfirm: "Ja, löschen",
    chooseSpecialist: "Spezialisten wählen",
    refresh: "Aktualisieren",
    notifications: "Benachrichtigungen",
    pendingOnlineBookings: "Ausstehende Online-Buchungen",
    pendingJoinRequests: "Teamanfragen",
    notificationsMessages: "Einladungen und Nachrichten",
    archivedOnlineBookings: "Archiv",
    notificationsEmpty: "Noch keine neuen Updates.",
    ...
    onlineBookingStatusPending: "Wartet auf Bestätigung",
    onlineBookingStatusConfirmed: "Bestätigt",
    onlineBookingStatusCancelled: "Storniert"
  }
};
...
export default function CalendarDayView({ professionalId, initialDate, initialPanel, onboardingCta = null }: CalendarDayViewProps) {
  ...
  async function saveVisit(saveWithoutClient = false) {
    ...
    const requestItems = visitItems.map((item) => ({
      ...
      customerName: selectedCustomer?.name.trim() || t.customer,
          ...
          <div className={styles.calendarV2Panel}>
            ...
            <div className={styles.calendarNotificationsPanel}>
              ...
              {pendingJoinRequests.length ? (
                <>
                  <div className={styles.calendarNotificationsHeading}>
                    <strong>{t.pendingJoinRequests}</strong>
                  ...
                  <div className={styles.calendarNotificationsList}>
                    {pendingJoinRequests.map((item) => (
                      <button
                        ...
                        type="button"
                        className={`${styles.calendarNotificationCard} ${styles.calendarNotificationCardInteractive}`}
                        onClick={handleJoinRequestNotificationSelect}
                      >
                        <div className={styles.calendarNotificationCardHeader}>
                          <strong>{t.joinRequestTitle}</strong>
                          <span>{formatActivityTime(item.createdAt, locale)}</span>
                        </div>
                        <div className={styles.calendarNotificationCardBody}>
                          <strong>{item.professionalName || t.masterFallback}</strong>
                          <span>{item.role || t.masterFallback}</span>
                          <small>{t.openJoinRequests}</small>
                        </div>
                      </button>
                    ))}
                  </div>
