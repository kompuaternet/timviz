...
const categoryNameTranslations: Record<string, LocalizedServiceText> = {
  "Волосы и стрижки": { ru: "Волосы и стрижки", uk: "Волосся та стрижки", en: "Hair & Haircuts", fr: "Cheveux et coupes", pl: "Włosy i strzyżenia", cs: "Vlasy a střihy", es: "Cabello y cortes", de: "Haare und Haarschnitte" },
  "Барбер и мужские стрижки": { ru: "Барбер и мужские стрижки", uk: "Барбер і чоловічі стрижки", en: "Barber & Men's Haircuts", fr: "Barbier et coupes homme", pl: "Barber i strzyżenia męskie", cs: "Barber a pánské střihy", es: "Barbería y cortes masculinos", de: "Barber und Herrenhaarschnitte" },
  "Мужской парикмахер": { ru: "Барбер и мужские стрижки", uk: "Барбер і чоловічі стрижки", en: "Barber & Men's Haircuts", fr: "Barbier et coupes homme", pl: "Barber i strzyżenia męskie", cs: "Barber a pánské střihy", es: "Barbería y cortes masculinos", de: "Barber und Herrenhaarschnitte" },
  "Волосы": { ru: "Волосы и стрижки", uk: "Волосся та стрижки", en: "Hair & Haircuts", fr: "Cheveux et coupes", pl: "Włosy i strzyżenia", cs: "Vlasy a střihy", es: "Cabello y cortes", de: "Haare und Haarschnitte" },
  ...
  "Парикмахерская": { ru: "Волосы и стрижки", uk: "Волосся та стрижки", en: "Hair & Haircuts", fr: "Cheveux et coupes", pl: "Włosy i strzyżenia", cs: "Vlasy a střihy", es: "Cabello y cortes", de: "Haare und Haarschnitte" },
  ...
  "Парикмахер": { ru: "Барбер и мужские стрижки", uk: "Барбер і чоловічі стрижки", en: "Barber & Men's Haircuts", fr: "Barbier et coupes homme", pl: "Barber i strzyżenia męskie", cs: "Barber a pánské střihy", es: "Barbería y cortes masculinos", de: "Barber und Herrenhaarschnitte" },
