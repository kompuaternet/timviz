...
export async function linkTelegramIdentityToProfessional(input: {
  ...
  const nextConnection: TelegramConnection = {
    ...
    notificationsToday: base?.notificationsToday ?? false,
...
export async function ensureTelegramConnectToken(input: {
  ...
  const nextConnection: TelegramConnection = {
    ...
    notificationsNewBooking: existing?.notificationsNewBooking ?? false,
    notificationsCabinetBooking: existing?.notificationsCabinetBooking ?? false,
    ...
    notificationsToday: existing?.notificationsToday ?? false,
